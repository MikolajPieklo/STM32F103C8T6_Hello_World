...
static void sh1106_set_cursor(uint8_t x, uint8_t y)
{
   do
   {
      ...
      I2C_Master_Reg8_Transmit_Byte(I2C2, SH1106_ADDRESS, 0x00, 0x10 + a);//Column address HI max 0x1F
   }
   while (0);
}
...
void SH1106_Init(void)
{
   ...
   status &= I2C_Master_Reg8_Transmit_Byte(I2C2, SH1106_ADDRESS, 0x00, 0xD5); // Display clock divide
   ...
   status &= I2C_Master_Reg8_Transmit_Byte(I2C2, SH1106_ADDRESS, 0x00, 0x00); // Column address LO max 0x0F
   status &= I2C_Master_Reg8_Transmit_Byte(I2C2, SH1106_ADDRESS, 0x00, 0x10); // Column address HI max 0x1F
