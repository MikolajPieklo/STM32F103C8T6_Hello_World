...
//   LL_APB2_GRP1_EnableClock(LL_APB2_GRP1_PERIPH_GPIOA); /* Enable the peripheral clock of GPIO Port */
//   LL_APB2_GRP1_EnableClock(LL_APB2_GRP1_PERIPH_USART1);/* Enable USART peripheral clock */
//
